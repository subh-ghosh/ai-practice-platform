            ...
            {loading ? (
                ...
                <Card className="border border-blue-gray-100 shadow-sm">
                    <CardBody className="text-center py-12">
                        <TrophyIcon className="h-16 w-16 mx-auto mb-4 text-blue-gray-200" />
                        ...
                        <table className="w-full min-w-[640px] table-auto text-left">
                            ...
                            <tbody>
                                {leaders.map((student, index) => {
                                    ...
                                    const className = `py-3 px-5 ${index === leaders.length - 1 ? "" : "border-b border-blue-gray-50"} ${isCurrentUser ? "bg-blue-50/50" : ""}`;
