  ...
  return (
    <div className="relative mt-6 mb-8 w-full h-[calc(100vh-175px)] overflow-hidden rounded-xl border border-blue-gray-50 dark:border-gray-800 shadow-sm bg-white dark:bg-gray-900">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 shrink-0">
          <div>
            ...
            <Typography variant="small" className="text-gray-500 dark:text-gray-400 font-normal mt-1">
              Generate questions, test your knowledge, and review your progress.
            </Typography>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto pr-2 pb-6 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-thumb]:bg-gray-800 [&::-webkit-scrollbar-thumb]:rounded-full hover:[&::-webkit-scrollbar-thumb]:bg-gray-400">
          ...
          >
            ...
            <motion.div variants={itemVariants}>
                <Card className="overflow-visible border border-blue-100/60 dark:border-gray-700 bg-white/60 dark:bg-gray-900/40 backdrop-blur-sm shadow-sm">
                  <CardHeader
                    floated={false}
                    shadow={false}
                  ...
                  >
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <Typography variant="h6" color="white" className="font-bold tracking-tight">
                    ...
                    {question && (
                      <div className="mt-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div className="mb-6">
                            ...
                            <div className="p-5 border border-gray-200 rounded-2xl bg-white dark:bg-gray-800/50 dark:border-gray-700">
            ...
            {/* --- History Card --- */}
            <motion.div variants={itemVariants}>
                <Card className="border border-blue-100/60 dark:border-gray-700 bg-white/60 dark:bg-gray-900/40 backdrop-blur-sm shadow-sm">
                  <CardHeader floated={false} shadow={false} color="transparent" className="m-0 p-6 flex flex-col md:flex-row gap-4 justify-between items-center border-b border-blue-gray-50 dark:border-gray-700/50">
      ...
      <Dialog open={!!selectedHistory} handler={() => setSelectedHistory(null)} size="lg" className="bg-white dark:bg-gray-900 border dark:border-gray-800">
            ...
            <DialogBody divider className="dark:border-gray-800 overflow-y-auto max-h-[70vh] p-6 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-thumb]:bg-gray-800 [&::-webkit-scrollbar-thumb]:rounded-full">
                {selectedHistory && (
                    <div className="space-y-8">
                        ...
                        <div>
                            ...
                            {(() => {
                                ...
                                return (
                                    <div className={`p-6 rounded-2xl prose prose-sm dark:prose-invert max-w-none overflow-x-auto leading-relaxed shadow-sm ${containerClass}`}>
                                        <ReactMarkdown remarkPlugins={[remarkGfm]}>
                                            {selectedHistory.evaluationStatus === "REVEALED" 
