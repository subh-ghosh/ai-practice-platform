...
items-center gap-6">
            ...
            <div className="w-96">
              {/* --- THIS IS THE FIX --- */}
              <Tabs value={activeTab} indicatorProps={{ className: "dark:bg-white" }}>
                <TabsHeader className="bg-blue-gray-50/60 dark:bg-gray-700">
                  <Tab
                    value="profile"
                    onClick={() => setActiveTab("profile")}
                    className="dark:text-gray-300 data-[state=active]:dark:text-gray-900"
                  >
              {/* --- END OF FIX --- */}
                    <UserCircleIcon className="-mt-1 mr-2
              ...
              <div className="grid grid-cols-1 gap-12">
                <div className="w-full max-w-lg">
                  <ProfileInfoCard
                    ...
                    description="Hi!
I'm a student using the AI Practice Platform to improve my skills."
                    details={{
...
>
                          {loading ?
<Spinner className="h-4 w-4" /> : "Save Profile Changes"}
                        </Button>
                      </CardBody>
                    </form>
                  </Card>
                      ...
                      <form onSubmit={handlePasswordChange} className="flex flex-col gap-6">
                       ...
                       {success && activeTab === 'security' && <Alert color="green">{success}</Alert>}
                        ...
                        <Button type="submit" variant="gradient" className="w-full md:w-1/2" disabled={loading}>
                          {loading
? <Spinner className="h-4 w-4" /> : "Change Password"}
                        </Button>
                      </form>
                    </CardBody>
                  </Card>
...
delete your account, there is no going back. Please be certain.
                      ...
                      <Button variant="outlined" color="red" onClick={handleDeleteAccount} disabled={loading}>
                        {loading ?
<Spinner className="h-4 w-4" /> : "Delete My Account"}
                      </Button>
                    </CardBody>
                  </Card>
                </div>
