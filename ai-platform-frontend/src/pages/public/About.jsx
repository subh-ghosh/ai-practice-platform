...
export function About() {
  return (
    // Outer Wrapper: Pure Dark Mode, No Light Mode classes
    <div className="relative w-full overflow-hidden bg-[#050505] min-h-screen flex flex-col font-sans selection:bg-blue-500/30 -mt-24">
      ...
      {/* - min-h-[110vh]: Ensures footer is just off-screen
          - justify-center: Vertically centers the card
          - pt-32: Offset to ensure card doesn't hit the transparent navbar 
      */}
      <section className="relative z-10 flex-1 w-full flex flex-col justify-center items-center pt-32 pb-20 min-h-[110vh]">
