...
export function About() {
  return (
    <div className="relative w-full overflow-hidden bg-[#050505] min-h-screen flex flex-col font-sans selection:bg-blue-500/30 -mt-24">
      ...
      {/* FIX: Changed min-h-screen to min-h-[115vh] to force scroll for footer */}
      <section className="relative z-10 flex-1 w-full flex items-center justify-center pt-40 pb-16 min-h-[115vh]">
