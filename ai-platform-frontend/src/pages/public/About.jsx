              ...
              <div className="rounded-[2.5rem] border border-white/5 bg-[#0a0a0c]/90 backdrop-blur-2xl shadow-2xl overflow-hidden p-8 md:p-10 relative flex flex-col items-center text-center">
                ...
                >
                  <a href="https://www.linkedin.com/in/subhh/" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
                    <MagneticButton className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3.5 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold text-sm hover:scale-105 hover:shadow-[0_0_20px_rgba(37,99,235,0.4)] transition-all duration-300">
                      <LinkedInIcon className="w-4 h-4" /> LinkedIn
                    </MagneticButton>
                  </a>

                  <a href="https://github.com/subh-ghosh" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
                    <MagneticButton className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3.5 rounded-full border border-white/10 text-slate-300 font-bold text-sm hover:bg-white/5 hover:text-white transition-colors duration-300">
