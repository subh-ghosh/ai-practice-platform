...
// --- 1. HERO SECTION (Zoom Out Effect) ---
const HeroScrollDemo = () => {
  ...
  const rotateX = useSpring(useTransform(scrollYProgress, [0, 0.3], [20, 0]), { stiffness: 100, damping: 30 });
  const scale = useSpring(useTransform(scrollYProgress, [0, 0.3], [0.85, 1]), { stiffness: 100, damping: 30 });
  const translateY = useSpring(useTransform(scrollYProgress, [0, 0.3], [-50, 0]), { stiffness: 100, damping: 30 });
    ...
    <div ref={containerRef} className="relative flex flex-col items-center justify-start pt-20 md:pt-40 min-h-[120vh] bg-[#050505] overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center px-4 mb-16">
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-blue-500/20 bg-blue-500/5 text-blue-400 text-sm font-medium mb-8 backdrop-blur-md"
        >
        ...
        >
          ...
          <button
            ...
            className="px-8 py-4 rounded-full border border-white/10 text-slate-300 font-medium text-lg hover:bg-white/5 hover:text-white transition-colors backdrop-blur-md"
          >
            View Dashboard
          </button>
        </motion.div>
    ...
    <section className="py-32 bg-[#050505] px-4 relative overflow-hidden z-10">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:auto-rows-[340px]">
          ...
          {/* Card 2 */}
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} whileHover={{ scale: 1.02 }} viewport={{ once: true }} transition={{ delay: 0.1, type: "spring", stiffness: 300, damping: 20 }} className="md:col-span-1 group relative rounded-[2rem] overflow-hidden bg-[#0a0a0c] border border-white/10 p-8 hover:border-amber-500/30 transition-all duration-500 shadow-lg">
            ...
            <div className="absolute top-8 right-8 flex flex-col gap-2 opacity-20 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
              ...
              <div className="h-8 w-20 bg-slate-500/10 border border-slate-500/20 rounded-lg flex items-center px-3 gap-2 ml-4 backdrop-blur-sm"><span className="text-slate-500 text-xs font-bold">#2</span><div className="h-1.5 w-8 bg-slate-500/40 rounded-full" /></div>
            </div>
            <div className="relative z-20 h-full flex flex-col justify-end mt-10">
              <div className="w-14 h-14 rounded-2xl bg-amber-500/10 border border-amber-500/20 flex items-center justify-center mb-6 text-amber-500 group-hover:scale-110 transition-transform duration-300"><TrophyIcon className="w-7 h-7" /></div>
              <div>
          ...
          {/* Card 3 */}
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} whileHover={{ scale: 1.02 }} viewport={{ once: true }} transition={{ delay: 0.2, type: "spring", stiffness: 300, damping: 20 }} className="md:col-span-1 group relative rounded-[2rem] overflow-hidden bg-[#0a0a0c] border border-white/10 p-8 hover:border-purple-500/30 transition-all duration-500 shadow-lg flex flex-col justify-between">
            ...
            <div className="relative z-20 mt-6">
              <div className="w-14 h-14 rounded-2xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center mb-6 text-purple-500 group-hover:scale-110 transition-transform duration-300"><ChartBarIcon className="w-7 h-7" /></div>
              <div>
          ...
          {/* Card 4 */}
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} whileHover={{ scale: 1.02 }} viewport={{ once: true }} transition={{ delay: 0.3, type: "spring", stiffness: 300, damping: 20 }} className="md:col-span-2 group relative rounded-[2rem] overflow-hidden bg-[#0a0a0c] border border-white/10 p-8 md:p-10 hover:border-indigo-500/30 transition-all duration-500 shadow-lg">
            ...
            <div className="relative z-20 h-full flex flex-col justify-between md:w-1/2">
              <div className="w-14 h-14 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center mb-6 text-indigo-400 group-hover:scale-110 transition-transform duration-300"><SparklesIcon className="w-7 h-7" /></div>
              <div>
                <h3 className="text-3xl font-bold text-white mb-3">Infinite Practice</h3>
                <p className="text-slate-400 text-lg leading-relaxed group-hover:text-slate-300 transition-colors">Never run out of material. Our AI generates unique scenarios on any topic, tailored to your skill level.</p>
              </div>
            </div>
          </motion.div>
        </div>
...
// --- 4. NEW: AI CORE REVEAL (Reverse Zoom-In Effect) ---
const AiCoreReveal = () => {
  const containerRef = useRef(null);
  ...
  const scale = useSpring(useTransform(scrollYProgress, [0, 1], [0.5, 1]), { stiffness: 100, damping: 30 });
  ...
  return (
    <div ref={containerRef} className="relative py-40 bg-[#050505] overflow-hidden flex items-center justify-center min-h-[100vh]">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(59,130,246,0.05),transparent_70%)]" />

      <motion.div
        style={{ scale, opacity, filter: blur, rotateX, perspective: 1000 }}
        className="relative z-10 w-[90%] max-w-5xl aspect-video rounded-[3rem] border border-blue-500/30 bg-[#0a0a0c]/80 backdrop-blur-3xl shadow-[0_0_100px_rgba(37,99,235,0.2)] flex flex-col items-center justify-center p-12 overflow-hidden"
      >
        {/* Internal Grid & Glow */}
        ...
        <CpuChipIcon className="w-24 h-24 text-blue-500 mb-8 relative z-10 drop-shadow-[0_0_20px_rgba(59,130,246,0.8)]" />
        <h2 className="text-4xl md:text-6xl font-black text-white mb-6 text-center relative z-10 tracking-tight">
          Powered by <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">Neural Engines</span>
        </h2>
        <p className="text-xl text-slate-400 max-w-2xl text-center relative z-10">
          Every line of code you write is evaluated in milliseconds against millions of data points to provide human-like feedback, architectural hints, and absolute precision.
        </p>

        {/* Decorative code lines flying */}
...
// --- 5. NEW: STICKY WORKFLOW JOURNEY (Scroll-Driven Narrative) ---
const WorkflowScroll = () => {
  ...
  // Map scroll progress to the 3 steps
  const step1Opacity = useTransform(scrollYProgress, [0, 0.2, 0.3], [1, 1, 0.2]);
  const step2Opacity = useTransform(scrollYProgress, [0.3, 0.45, 0.6, 0.7], [0.2, 1, 1, 0.2]);
  const step3Opacity = useTransform(scrollYProgress, [0.7, 0.85, 1], [0.2, 1, 1]);

  // 3D Visual transformations based on scroll
  const visualRotateY = useSpring(useTransform(scrollYProgress, [0, 1], [-20, 20]), { stiffness: 50, damping: 20 });
  const visualScale = useSpring(useTransform(scrollYProgress, [0, 0.5, 1], [0.9, 1.1, 0.9]), { stiffness: 50, damping: 20 });

  return (
    <div ref={containerRef} className="relative h-[300vh] bg-[#050505]">
      {/* Sticky Container */}
      <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(139,92,246,0.05),transparent_80%)]" />
        ...
        <div className="max-w-7xl mx-auto px-4 w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col gap-20 py-20">
            <motion.div style={{ opacity: step1Opacity }} className="transition-opacity duration-300">
              <div className="w-12 h-12 rounded-full bg-blue-500/10 border border-blue-500/30 flex items-center justify-center text-blue-500 font-bold text-xl mb-6 shadow-[0_0_15px_rgba(59,130,246,0.3)]">1</div>
              <h3 className="text-4xl font-bold text-white mb-4">Curated Study Plans</h3>
              <p className="text-xl text-slate-400">Tell us what you want to learn. Our engine generates a day-by-day curriculum with embedded video tutorials and practice checkpoints.</p>
            </motion.div>

            <motion.div style={{ opacity: step2Opacity }} className="transition-opacity duration-300">
              <div className="w-12 h-12 rounded-full bg-purple-500/10 border border-purple-500/30 flex items-center justify-center text-purple-500 font-bold text-xl mb-6 shadow-[0_0_15px_rgba(168,85,247,0.3)]">2</div>
              <h3 className="text-4xl font-bold text-white mb-4">Execute in Browser</h3>
              <p className="text-xl text-slate-400">No installations required. Write, compile, and run complex Java or Python programs in a distraction-free, dark-mode optimized IDE.</p>
            </motion.div>

            <motion.div style={{ opacity: step3Opacity }} className="transition-opacity duration-300">
              <div className="w-12 h-12 rounded-full bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-amber-500 font-bold text-xl mb-6 shadow-[0_0_15px_rgba(245,158,11,0.3)]">3</div>
              <h3 className="text-4xl font-bold text-white mb-4">Track & Dominate</h3>
              <p className="text-xl text-slate-400">Every keystroke builds your profile. Track accuracy, speed, earn XP, and climb the global leaderboard to prove your mastery.</p>
            </motion.div>
          </div>

          {/* Right Visual Side (Floating Hologram) */}
          <div className="hidden md:flex items-center justify-center h-full perspective-[1000px]">
            <motion.div
              style={{ rotateY: visualRotateY, scale: visualScale, transformStyle: "preserve-3d" }}
              className="w-full aspect-square relative"
            >
              {/* Central Glowing Core */}
              <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/20 to-purple-500/20 rounded-full blur-[80px]" />

              {/* Glass Card acting as a screen */}
              <div className="absolute inset-4 bg-[#0a0a0c]/80 backdrop-blur-2xl rounded-[3rem] border border-white/10 shadow-2xl overflow-hidden flex flex-col items-center justify-center p-8">
                {/* We use framer motion to cross-fade icons inside the glass card based on scroll */}
                <motion.div style={{ opacity: step1Opacity }} className="absolute inset-0 flex flex-col items-center justify-center text-blue-500">
                  <PlayCircleIcon className="w-32 h-32 mb-6 opacity-80" />
                  <div className="text-2xl font-bold tracking-widest uppercase">Building Plan...</div>
                </motion.div>
                <motion.div style={{ opacity: step2Opacity }} className="absolute inset-0 flex flex-col items-center justify-center text-purple-500">
                  <CodeBracketIcon className="w-32 h-32 mb-6 opacity-80" />
                  <div className="text-2xl font-bold tracking-widest uppercase">Compiling Code...</div>
                </motion.div>
                <motion.div style={{ opacity: step3Opacity }} className="absolute inset-0 flex flex-col items-center justify-center text-amber-500">
                  <CheckBadgeIcon className="w-32 h-32 mb-6 opacity-80" />
                  <div className="text-2xl font-bold tracking-widest uppercase">Mastery Achieved</div>
                </motion.div>
              </div>
            </motion.div>
          </div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-4xl md:text-6xl font-black text-white mb-6 tracking-tight">
              Start your <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-500">7-Day Streak</span>
            </h2>
